...
print
print "Everything here should be concealed."
...
print "Everything above here should be concealed"

print

# Crossed
    printCrossed "Print crossed"
    printRedCrossed "Print reds crossed"
    printGreenCrossed "Print green crossed"
    printBlueCrossed "Print blue crossed"
    printCyanCrossed "print cyan crossed"
    printYellowCrossed "Print yellow crossed"
    printMagentaCrossed "Print magenta crossed"
    printWhiteCrossed "Print White crossed"
    printBlackCrossed "Print Black crossed"